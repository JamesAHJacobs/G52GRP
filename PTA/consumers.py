...
This file defines the python methods that will update the site when a trade is pushed into the system, as well as
handling the data being held in the brower session that allows the site to live update.
